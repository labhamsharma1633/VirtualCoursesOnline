        ...
        <table className='min-w-full text-sm'>
          ...
          <tbody>
            ...
            <tr key={index} className='border-b hover:bg-gray-50 transition duration-200'>
              ...
              <td className='px-4 py-3'><span className={`px-3 py-1 rounded-full text-x5 ${course?.isPublished ? "bg-green-100 text-green-600": "bg-red-100 text-red-600"}`}>{course?.isPublished? "Published":"Draft" }</span></td>
    ...
    {/* for Small Screen table */}
      <div className='md:hidden space-y-4'>
        ...
        <div key={index}className='bg-white rounded-lg shadow p-4 flex flex-col gap-3'>
            ...
            { course?.thumbnail?<img src={course?.thumbnail} alt="" className='w-16 h-16 rounded-md object-cover' />:<img src={img} lat="" className='w-16 h-16 rounded-md object-cover'/>}
