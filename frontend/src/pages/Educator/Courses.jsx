    ...
    <div className='flex min-h-screen bg-gray-100'>
      ...
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3'>
        <div className='flex items-center justify-center gap-3'>
          ...
          <h1 className='text-2xl font-semibold'>All Creaated Courses</h1>
        ...
        <table className='min-w-full text-sm'>
          ...
          <tbody>
            <tr className='border-b hover:bg-gray-50 transition-duration-200'>
              ...
              <td className='px-4 py-3'><span className='px-3 py-1 rounded-full text-x5 bg-red-100 text-red-600'>Draft</span></td>
